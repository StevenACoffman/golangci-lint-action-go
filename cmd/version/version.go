...
//
//	go build -ldflags \
//	  "-X 'github.com/StevenACoffman/golangci-lint-action-go/cmd/version.Version=v1.2.3'"
var Version = "dev"
...
func New(parent *root.Config) *Config {
	...
	cfg.Command = &ff.Command{
		Name:      "version",
		Usage:     "golangci-lint-action-go version [--json]",
		ShortHelp: "print version information",
		LongHelp: `Print build and version information for this golangci-lint-action-go binary.
